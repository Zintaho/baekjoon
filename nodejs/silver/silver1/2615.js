...
for (let x = 0; x < 19; ++x) {
    for (let y = 0; y < 19; ++y) {
        ...
        if (isValid) {
            if (x + 5 < 19 && y + 5 < 19 && input[y + 5][x + 5] === a) isValid = false;
            if (x - 1 >= 0 && y - 1 >= 0 && input[y - 1][x - 1] === a) isValid = false;
        }
        if (isValid) {
            answer = a;
            X = x;
        ...
        if (isValid) {
            if (x + 5 < 19 && y - 5 >= 0 && input[y - 5][x + 5] === a) isValid = false;
            if (x - 1 >= 0 && y + 1 < 19 && input[y + 1][x - 1] === a) isValid = false;
        }
        if (isValid) {
            answer = a;
            X = x;
